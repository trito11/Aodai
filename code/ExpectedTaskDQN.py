...
class ExpectedTaskDQN(AbstractDQNAgent):
    ...
    def __init__(self, model, policy=None, test_policy=None, enable_double_dqn=False, enable_dueling_network=False,
        ...
        self.expected_computation = 0.55
        self.expected_deadline = 1.25
    ...
    def forward(self, observation):
        ...
        # self.expected_inputsize = 0.999 * self.expected_inputsize + 0.001 * observation[-2]
        # self.expected_computation = 0.999 * self.expected_computation + 0.001 * observation[-3]
        # self.expected_deadline = 0.999 * self.expected_deadline + 0.001 * observation[-1]
